...
RSpec.describe StockProduct, type: :model do
  describe "gera um número de série" do
    ...
    it 'ao criar um StockProduct' do    
      stock_prod = StockProduct.create!(order: @order, warehouse:@warehouse, product_model: @pm)
      expect(stock_prod.serial_number.length).to eq 20 
    end
    ...
    it 'e não é modificado' do
      ...
      stock_prod = StockProduct.create!(order: @order, warehouse: @warehouse, product_model: @pm)
      original_serial_number = stock_prod.serial_number
      stock_prod.update(warehouse: warehouse)
      expect(stock_prod.serial_number).to eq original_serial_number
    end
  end
